...
// Kushal Prajapati
  ...
  public static void createAccount(ClientList clients){
    Scanner input = new Scanner(System.in);
    System.out.println("Enter the ID of the client");
    int ID = input.nextInt();
    int idx = clients.searchByID(ID);
    ClientList.Node current = clients.findNodeByIndex(idx);
  ...
  public static void transfer(ClientList clients) throws IOException {
    ...
    ClientList.Node current2=clients.findNodeByIndex(idx2);
    Client client2= current2.client;
    System.out.println("Enter the number of the account of the second client");
    int accountIdx2= input.nextInt()-1;
...
//      Client.StoreClient(temp.client);
  ...
  public static void ModifyAccounts (Client currentClient) {
    Scanner input = new Scanner(System.in);
    System.out.println("Enter the index of the account you want to modify");
